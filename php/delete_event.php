...
try {
    ...
    $mail->Body = "
        <h1>Уведомление о статусе мероприятия</h1>
        <p>Уважаемый организатор,</p>
        <p>Мы сообщаем вам, что ваше мероприятие <strong>\"{$eventTitle}\"</strong> было удалено с платформы <strong>MEET</strong>.</p>
        <p>Если у вас возникнут вопросы или вы хотите обсудить дальнейшие действия, пожалуйста, свяжитесь с нашей командой.</p>
        <p>С уважением,</p>
        <p>Команда MEET</p>
    ";

    $mail->AltBody = "Уважаемый организатор,\n\n"
        . "Мы сообщаем вам, что ваше мероприятие \"$eventTitle\" было удалено с платформы MEET.\n\n"
        . "Если у вас возникнут вопросы или вы хотите обсудить дальнейшие действия, пожалуйста, свяжитесь с нашей командой.\n\n"
        . "С уважением,\nКоманда MEET.";
