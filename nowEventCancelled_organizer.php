    ...
    <div class="container">
        <div class="lk">
            ...
            <div class="lk__profile">
                ...
                <div class="links">
                    <a href="./nowEventActive_organizer.php" class="no_active">Активные мероприятия</a>
                    <a href="./nowEventCancelled_organizer.php" class="active">Неактивные мероприятия</a>
                </div>
                <div class="cards">
                    <?php
                    if ($resultGetEvents && pg_num_rows($resultGetEvents) > 0) {
                        ...
                        echo "<p>Нет отменненых мероприятий для отображения.</p>";
                    }
                    ?>
                </div>
